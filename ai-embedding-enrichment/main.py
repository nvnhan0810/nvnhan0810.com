...
def enrich_data(request: ArticleRequest, _: str = Depends(verify_api_key)):
    ...
    # keyphrase_ngram_range=(1, 2) nghĩa là cho phép từ khóa gồm 1 hoặc 2 từ
    keywords = kw_model.extract_keywords(
        text, keyphrase_ngram_range=(1, 2), stop_words=None, top_n=5
    )

    # KeyBERT trả về list tuple: [('từ khóa 1', 0.85), ...]
