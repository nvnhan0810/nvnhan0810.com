  ...
  return (
    <PrivateLayout auth={auth}>
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-foreground">Reading Profile</h1>
        <Button variant="outline" onClick={reset}>Reset profile</Button>
      </div>
      <h2 className="text-lg font-semibold text-foreground mb-2">Interest scores</h2>
      ...
      <h2 className="text-lg font-semibold text-foreground mb-2">Explicit preferences</h2>
